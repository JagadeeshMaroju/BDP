...
#question 1
df = spark.read.csv(r"C:\Users\jagad\Downloads\survey.csv",header=True)
...
# def parseLine(row):
#     csvdata = csv.reader([row], delimiter=',', quotechar='"')
#     for i in csvdata:
#         print(i)
#
#
# dataRead_data = df.rdd.map(parseLine)
# print(dataRead_data.collect())
